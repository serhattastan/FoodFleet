 ...
 */
data class Cart(
    val sepet_yemek_id: Int,          // Sepetteki yemeğin benzersiz ID'si
    val yemek_adi: String,            // Yemeğin adı
    val yemek_resim_adi: String,      // Yemeğin görsel dosya adı veya URL'si
    val yemek_fiyat: Int,             // Yemeğin birim fiyatı
    val yemek_siparis_adet: Int,      // Sipariş edilen yemeğin miktarı
